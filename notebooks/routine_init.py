...
lambda_2 = 0
shape = "multi"
sdf_pretrain="sphere"   # Initial condition ("sphere" or "plane")
flip_ratio_list=[0.15, 0.2, 0.25]
# wedge_axis='y'
# hetero_scale=5
threshold=0.8
...
for flip_ratio in flip_ratio_list:
	...
	data_dire = f"data_1115/a{str(flip_ratio).replace('.', '')}/init"
	...
	checkpoint_dir = os.path.abspath(f"../outputs/logs/{shape}/{data_dire}/lambda_{lambda_1}_{lambda_2}")
