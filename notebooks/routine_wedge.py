...
for axis_angle in axis_angle_list:
	for tilt_max in tilt_max_list:
		for shape in shape_list:
			...
			#### LOAD MRC DATA #####
			mrc_file_path = f"../data/synthetic/wedge/{shape}_a{flip_str}_w{axis_angle:02d}_t{tilt_max:02d}.mrc"
			...
			for lambda_2 in lambda_2_list:
				...
				checkpoint_dir = os.path.abspath(f"../outputs/logs/{shape}/{data_version}/wedge/a{flip_str}_w{axis_angle:02d}_t{tilt_max:02d}/lambda_{lambda_1}_{lambda_2}")
