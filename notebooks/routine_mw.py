...
shape = "bud_04"
sdf_pretrain="plane"   # Initial condition ("sphere" or "plane")
flip_ratio=0.0
wedge_axis='y'
...
for threshold in threshold_list:
	...
	for lambda_2 in lambda_2_list:
		...
		checkpoint_dir = os.path.abspath(f"../outputs/logs/{shape}/data_0926/m{wedge_axis}-{threshold_str}/lambda_{lambda_1}_{lambda_2}")
