...
def run_one(
    ...
    if sdf_pretrain == "checkpoint":
        ...
        checkpoint_dir = os.path.abspath(f"{root_dir}/lambda_{lambda_1}_{lambda_2}_{lambda_3}_test_b3_n80000")
    else:
    ...
    if sdf_pretrain == "checkpoint":
        ...
        init_ckpt_path = f"{root_dir}/lambda_100000_10_100000_cont/checkpoint_10000"
    ...
    # edge = load_pts_data(f"{pts_path}/edge/e_{shape}_a01_w00_t60.npz", perm=(2,1,0))
    sign = load_pts_data(f"{pts_path}/sign/s_{shape}.npz", perm=(2,1,0))
    # phys = load_pts_data(f"{pts_path}/phys/p_{shape}.npz", perm=(2,1,0))
    phys = load_pts_data(f"{pts_path}/phys/p_biconcave_b3_n80000.npz", perm=(2,1,0))
